...
This repository contains the conceptual definition and theoretical framework for **Optimization Task**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── optimization-task.tex    # LaTeX dissertation
├── whitepaper/
│   └── optimization-task.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025optimizationtask,
  author = {Vega, Adam Eren},
  title = {Optimization Task: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/optimization-task}
}
```
